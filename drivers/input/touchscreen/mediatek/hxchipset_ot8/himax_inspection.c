...
static int himax_self_test_data_init(void)
{
	...
	snprintf(g_file_path, (int)(strlen(HX_RSLT_OUT_PATH)
			...
			"%s%s_%s_%s.txt", HX_RSLT_OUT_PATH, HX_RSLT_OUT_FILE,ts->himax_name, get_date_time_str());
...
END:
        ...
        I("%s:OUT\n", __func__);
		/*TabA7 Lite code for OT8-5389 by suyurui at 20220323 start*/
        g_core_fp.fp_read_FW_ver();
        /*TabA7 Lite code for OT8-5389 by suyurui at 20220323 end*/
        return ret;
}
