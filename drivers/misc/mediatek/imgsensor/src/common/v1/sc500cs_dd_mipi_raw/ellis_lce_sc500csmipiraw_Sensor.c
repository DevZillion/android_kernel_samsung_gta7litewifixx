...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = SC500CS_DD_SENSOR_ID,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
  { 2592, 1944,      0,    0, 2592, 1944, 1296, 972, 0000, 0000, 1296, 
972,    0,    0, 1296, 972}, // Preview
  { 2592, 1944,      0,    0, 2592, 1944, 2592, 1944, 0000, 0000, 2592, 
1944,    0,    0, 2592, 1944}, // capture
  { 2592, 1944,      0,    0, 2592, 1944, 2592, 1944, 0000, 0000, 2592, 
1944,    0,    0, 2592, 1944}, // video
  { 2592, 1944,      16,    252, 2560, 1440, 1280, 720, 0000, 0000, 1280, 
720,    0,    0, 1280, 720}, //hight speed video
  { 2592, 1944,      16,    252, 2560, 1440, 1280, 720, 0000, 0000, 1280, 
720,    0,    0, 1280, 720},};// slim video
...
static void preview_setting(void)
{
	...
	ellis_lce_sc500cs_table_write_cmos_sensor(
     ...
     write_cmos_sensor8(0x36ea,0x35);
     write_cmos_sensor8(0x36eb,0x0c);
     write_cmos_sensor8(0x36ec,0x4b);
     write_cmos_sensor8(0x36ed,0x26);
     write_cmos_sensor8(0x36fa,0x39);
     write_cmos_sensor8(0x36fb,0xa6);
     ...
     write_cmos_sensor8(0x4837,0x24);
     ...
     write_cmos_sensor8(0x3211,0x04);
     write_cmos_sensor8(0x4837,0x48);
     write_cmos_sensor8(0x3308,0x10);
	 write_cmos_sensor8(0x4823,0x2c);  //0x3c
...
static void hs_video_setting(void)
{
	...
	ellis_lce_sc500cs_table_write_cmos_sensor(
     ...
     write_cmos_sensor8(0x3211,0x04);
     write_cmos_sensor8(0x4837,0x46);
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	if (*sensor_id != imgsensor_info.sensor_id) {
		pr_err("mjf_ellis_lce_sc500cs Read id fail,sensor id: 0x%x\n", *sensor_id);
...
UINT32 SC500CS_DD_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **
pfFunc)
{
