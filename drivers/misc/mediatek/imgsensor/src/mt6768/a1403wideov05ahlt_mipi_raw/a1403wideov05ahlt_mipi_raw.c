...
/*hs14 code for ASR-AL6528A-01-60 by jianghongyan at 2022-10-20 start*/
	...
	/*	  MIPI_sensor_Init	*/
{
			...
			write_cmos_sensor(0xfb, 0x43);   //;mipi output size
...
/*hs14 code for ASR-AL6528A-01-60 by jianghongyan at 2022-10-20 end*/
