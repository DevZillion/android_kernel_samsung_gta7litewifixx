...
)
{
	...
	/* ­pºâtmp_lb_gain ¥Îšìªºfunction hex2dec() ¬O±N twos complementªº€Q€»¶iŠìÂàŠš€Q¶iŠì, €Q€»¶iŠìªº®æŠ¡¬°s11.10
	* Á|šÒ1, d00[10:0] = h'3ff, žg¹L hex2dec(h'3ff) = 1023,
	* Á|šÒ2, d00[10:0] = h'400, žg¹L hex2dec(h'400) = -1024,
	* Á|šÒ3, d00[10:0] = h'0A9, žg¹L hex2dec(h'0A9) = 169,
	* Á|šÒ4, d00[10:0] = h'54c, žg¹L hex2dec(h'54c) = -692,
	* Á|šÒ5, d00[10:0] = h'7ff, žg¹L hex2dec(h'7ff) = -1, */
...
)
{
	...
	do {
		...
		/* ª`·Npage c1ªºc90ŠbDPK¹Lµ{€€€džU€£¯à³Qšä¥Lthread or process§ïŒgŠšpage cªºc90­È */
		odm_write_4byte(dm, 0xc90, 0x0101f018);

		/* one shot */
		odm_write_4byte(dm, 0xcc8, 0x800c5599);
		odm_write_4byte(dm, 0xcc8, 0x000c5599);
		/* delay 50 ms,Åý delay ®É¶¡ªø€@ÂI, œT©w PA Scan function Š³°µ§¹ */
		delay_ms(50);

		/* reg82c[31] = 0 --> €Ášì page C */
...
)
{
	...
	odm_set_bb_reg(dm, R_0xcd4, 0xFFF000, 0x100);  /* ±Ncd4[23:12] §ïŠš h'100, šä¥ŠŠì€žœÐ«O¯d­ì­È€£­nŒgšì
     * ª`·Npage c1ªºc90ŠbDPK¹Lµ{€€€džU€£¯à³Qšä¥Lthread or process§ïŒgŠšpage cªºc90­È */
	odm_write_4byte(dm, 0xc90, 0x0101f018);
...
)
{
	...
	/* regc20[15:13] = dB sel, §i¶D Gain Loss function ¥hŽM§ä dB_sel ©Ò³]©wªºPA gain loss¥ØŒÐ©Ò¹ïÀ³ªº Tx AGC ¬°Šó. */
	...
	/* read back Loopback Gain */
	/* ¥i¥HŠb d00[3:0] €€ÅªŠ^, dB_sel €€©Ò³]©wªº gain loss ·|žšŠb­þ€@­Ó Tx AGC ³]©w */
	/* ÅªŠ^d00[3:0] = h'1 ' Tx AGC = h'13 */
	/* ÅªŠ^d00[3:0] = h'2 ' Tx AGC = h'14 */
	/* ÅªŠ^d00[3:0] = h'3 ' Tx AGC = h'15 */
	/* ÅªŠ^d00[3:0] = h'4 ' Tx AGC = h'16 */
	/* ÅªŠ^d00[3:0] = h'5 ' Tx AGC = h'17 */
	/* ÅªŠ^d00[3:0] = h'6 ' Tx AGC = h'18 */
	/* ÅªŠ^d00[3:0] = h'7 ' Tx AGC = h'19 */
	/* ÅªŠ^d00[3:0] = h'8 ' Tx AGC = h'1a */
	/* ÅªŠ^d00[3:0] = h'9 ' Tx AGC = h'1b */
	/* ÅªŠ^d00[3:0] = h'a ' Tx AGC = h'1c */
	/*  */
...
)
{
	...
	/* RF setting, ­«·s³]©wRF reg00, Á|šÒ¥ÎDPK Phase 2±ošìªº d00[3:0] = 0x6 ' TX AGC= 0x18 ' RF reg00[4:0] = 0x18 */
...
)
{
	...
	/* reg82c[31] = 0 --> €Ášì page C */
	odm_write_4byte(dm, 0x82c, 0x002083dd);
	/* RF setting, Š¹³BRF reg00, »P DPK Phase 3 €@­P */
	odm_set_rf_reg(dm, RF_PATH_A, RF_0x00, RFREGOFFSETMASK, cali_info->dpk_tx_agc);
	...
	cali_info->dpk_thermal[RF_PATH_A] = odm_get_rf_reg(dm, RF_PATH_A, RF_0x42, 0xFC00);					/* Åª¥X42[15:10] ­ÈšÃŠsšìÅÜŒÆTMeter */
	...
	odm_write_4byte(dm, 0xcb8, 0x00000000);
	/* dp_fail³o­ÓbitŠbd00[6], ·í d00[6] = 1, ªí¥Ücalibration¥¢±Ñ. */
	reg0xd00 = odm_read_4byte(dm, 0xd00);
	...
	/* ­pºâtmpGainLoss ¥Îšìªºfunction hex2dec() ¬O±N twos complementªº€Q€»¶iŠìÂàŠš€Q¶iŠì, €Q€»¶iŠìªº®æŠ¡¬°s11.9 */
	/* Á|šÒ1, d00[10:0] = h'3ff, žg¹L hex2dec(h'3ff) = 1023, */
	/* Á|šÒ2, d00[10:0] = h'400, žg¹L hex2dec(h'400) = -1024, */
	/* Á|šÒ3, d00[10:0] = h'0A9, žg¹L hex2dec(h'0A9) = 169, */
	/* Á|šÒ4, d00[10:0] = h'54c, žg¹L hex2dec(h'54c) = -692, */
	/* Á|šÒ4, d00[10:0] = h'7ff, žg¹L hex2dec(h'7ff) = -1, */
	tmp_lb_gain = _compute_loop_back_gain_path_a(dm);
...
)
{
	...
	/* enable IQC matrix --> Š]¬° BB «Hž¹·|¥ýžg¹L predistortion module, €~žg¹L IQC matrix šì DAC ¥Ž¥X¥h */
	/* ©Ò¥H­n¥ý enable predistortion module {c90[7] = 1 (enable_predis) cc4[18] = 1 (œT©wÅý IQK/DPK module Š³clock), cc8[29] = 1 (€@­ÓIQK/DPK module žÌªºmux, œT»{ data path š«IQK/DPK)} */
	...
	if (cali_info->is_dpk_fail) {
		...
		/* PWSF */
		/* ŒgPWSF table in 1st SRAM for PA = 11 use */
		odm_write_4byte(dm, 0xc20, 0x00000800);

		/* ******************************************************* */
		/* 0xce4[0]¬Owrite enable¡A0xce4[7:1]¬Oaddress¡A0xce4[15:8]©M0xce4[23:16]¹ïÀ³šìTX index¡A */
		/* ­YŠìžm¬°0(0xce4[7:1] = 0x0)Š¹®É0xce4[15:8]¹ïÀ³šìªºTX RF index ¬O0x1f,¡A */
		/* 0xce4[23:16]¹ïÀ³šìªº¬O0x1e¡A­YŠìžm¬°1(0xce4[7:1] = 0x1)¡AŠ¹®É0xce4 [15:8]¹ïÀ³šì0x1d¡A */
		/* 0xce4[23:16]¹ïÀ³0x1c¡Ašä¥LšÌŠ¹Ãþ±À¡AšC­ÓdataÄæŠì³£¬O¬Û®t1dB¡C­Ygainloss§äšìªºRF TX index=0x18¡A */
		/* «hŠb0xce4 address¹ïÀ³šì0x18ªºŠa€è­n¶ñ0x40(€]ŽN¬O0dB)¡Ašä¥L«h·Ó€U­±tableªº¶¶§ÇšC®æ1dBšÌ§Ç±ÆŠC */
		/* ±N©ÒŠ³ªº0xce4cªºdataÄæŠì³£¶ñ€J¬Û¹ïÀ³ªº­È¡C */
		/* ************************************************************* */
...
)
{
	...
	odm_set_bb_reg(dm, R_0xed4, 0xFFF000, 0x100);  /* ±Ncd4[23:12] §ïŠš h'100, šä¥ŠŠì€žœÐ«O¯d­ì­È€£­nŒgšì
     * ª`·Npage c1ªºc90ŠbDPK¹Lµ{€€€džU€£¯à³Qšä¥Lthread or process§ïŒgŠšpage cªºc90­È */
	odm_write_4byte(dm, 0xe90, 0x0101f018);
...
)
{
	...
	/* read back Loopback Gain */
	/* ¥i¥HŠb d40[3:0] €€ÅªŠ^, dB_sel €€©Ò³]©wªº gain loss ·|žšŠb­þ€@­Ó Tx AGC ³]©w */
	/* ÅªŠ^d00[3:0] = h'1 ' Tx AGC = h'13 */
	/* ÅªŠ^d00[3:0] = h'2 ' Tx AGC = h'14 */
	/* ÅªŠ^d00[3:0] = h'3 ' Tx AGC = h'15 */
	/* ÅªŠ^d00[3:0] = h'4 ' Tx AGC = h'16 */
...
)
{
	...
	/* RF setting, ­«·s³]©wRF reg00, Á|šÒ¥ÎDPK Phase 2±ošìªº d40[3:0] = 0x6 ' TX AGC= 0x18 ' RF reg00[4:0] = 0x18 */
...
)
{
	...
	/* T-meter RFReg42[17] = 1 to enable read T-meter, [15:10] ' T-meter value */
	odm_set_rf_reg(dm, RF_PATH_A, RF_0x42, BIT(17), 1);
	cali_info->dpk_thermal[RF_PATH_B] = odm_get_rf_reg(dm, RF_PATH_A, RF_0x42, 0xFC00);					/* Åª¥X42[15:10] ­ÈšÃŠsšìÅÜŒÆTMeter */
	...
	/* read back dp_fail report */
	odm_write_4byte(dm, 0xeb8, 0x00000000);
	/* dp_fail³o­ÓbitŠbd40[6], ·í d40[6] = 1, ªí¥Ücalibration¥¢±Ñ. */
	reg0xd40 = odm_read_4byte(dm, 0xd40);
...
)
{
	...
	if (cali_info->is_dpk_fail) {
		...
		/* ******************************************************* */
		/* 0xee4[0]¬Owrite enable¡A0xee4[7:1]¬Oaddress¡A0xee4[15:8]©M0xee4[23:16]¹ïÀ³šìTX index¡A */
		/* ­YŠìžm¬°0(0xee4[7:1] = 0x0)Š¹®É0xee4[15:8]¹ïÀ³šìªºTX RF index ¬O0x1f,¡A */
		/* 0xee4[23:16]¹ïÀ³šìªº¬O0x1e¡A­YŠìžm¬°1(0xee4[7:1] = 0x1)¡AŠ¹®É0xee4 [15:8]¹ïÀ³šì0x1d¡A */
		/* 0xee4[23:16]¹ïÀ³0x1c¡Ašä¥LšÌŠ¹Ãþ±À¡AšC­ÓdataÄæŠì³£¬O¬Û®t1dB¡C­Ygainloss§äšìªºRF TX index=0x18¡A */
		/* «hŠb0xee4 address¹ïÀ³šì0x18ªºŠa€è­n¶ñ0x40(€]ŽN¬O0dB)¡Ašä¥L«h·Ó€U­±tableªº¶¶§ÇšC®æ1dBšÌ§Ç±ÆŠC */
		/* ±N©ÒŠ³ªº0xee4cªºdataÄæŠì³£¶ñ€J¬Û¹ïÀ³ªº­È¡C */
		/* ************************************************************* */
